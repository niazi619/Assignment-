...
import com.wanologicalsolutions.apps.bankadmin.databinding.LayoutLoadStateViewBinding
...
class PaginationLoadStateAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): LoadStateViewHolder {
        return LoadStateViewHolder(
            LayoutLoadStateViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }

    class LoadStateViewHolder(val loadStateViewBinding: LayoutLoadStateViewBinding) :
